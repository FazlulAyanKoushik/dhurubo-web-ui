      ...
      .subscribe(res => {
        if (res.success) {
          ...
          this.bulkSmsService.sendMessageWithSubscribe(
            '88' + data.phoneNo,
            `Dear ${data.fullName}, Welcome to Dhurobo Ht. Enjoy authentic home appliances at country’s most trusted electronics store www.dhuroboht.com. Hotline: 8809610001010.`
          );
        } else {
