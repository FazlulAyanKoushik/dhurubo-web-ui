    ...
    this.warrantyService.checkWarrantByCustomerPhoneNo(data)
      .subscribe(res => {
        if (res.success) {
          ...
          const message = this.generatedOtpCode + ' is your OTP (One-Time Password) for password reset at Dhurobo Ht. Please enter the OTP to the verification page. Thanks.';
          // Sent Message
    ...
    this.warrantyService.trackWarrantDownloadHistory(data._id)
      .subscribe(res => {
        ...
        if (res.success) {
          ...
          pdfMake.createPdf(docDataRef, null, this.fonts).download(`Warranty_Document_By_Dhurobo_Ht.pdf`);
        } else {
      ...
      content: [
        ...
        },
        {
          text: [
            ...
            'from Dhurobo Ht. The Dhurobo Ht invoice number for this purchase is ',
        ...
        },
        {
          ul: [
            ...
            'The limited warranty period will no longer be valid if the product is repaired or serviced by anyone other than Dhurobo Ht or its authorized service provider.',
        ...
        },
        {
          columns: [
            [
              ...
              {
                text: 'Dhurobo ht Customer Care Limited',
                alignment: 'left',
                fontSize: 10,
              },
              {
              ...
              {
                text: 'Email: ecommerce@Dhuroboht.com',
                alignment: 'left',
                fontSize: 10,
              },
              {
                text: ['Web: ', {text: 'www.Dhuroboht.com', link: 'https://Dhuroboht.com/', color: 'blue'}],
                alignment: 'left',
                fontSize: 10,
              },
            ],
