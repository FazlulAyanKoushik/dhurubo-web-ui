...
export class HomeComponent implements OnInit {
  ...
  private getRecommendedProducts() {
    this.productService.getRecommendedProducts(this.storageService.getViewedProductData())
      .subscribe(res => {
        this.recommendedProducts = res.data.filter(item => item.quantity && item.quantity > 0);
  ...
  private updateMetaData() {
    // Title
    this.title.setTitle('Dhurobo Ht Enterprise - Home');
    // Meta
    this.meta.updateTag({name: 'robots', content: 'index, follow'});
    this.meta.updateTag({name: 'description', content: 'Dhurobo Ht Enterprise is the sole authorized distributor of SHARP and GENERAL in Bangladesh. Shop online and enjoy massive discounts and free home delivery.'});
    this.meta.updateTag({name: 'keywords', content: 'online shop, dhurobo,dhuroboht.com'});
    // Facebook
    this.meta.updateTag({name: 'og:title', content: 'Dhurobo  - Home'});
    this.meta.updateTag({name: 'og:type', content: 'website'});
    this.meta.updateTag({name: 'og:url', content: 'https://dhuroboht.com/'});
    this.meta.updateTag({name: 'og:image', content: 'https://dhuroboht.com/assets/brand/dhurobo.png'});
    this.meta.updateTag({name: 'og:description', content: 'Dhurobo is the sole authorized distributor of SHARP and GENERAL in Bangladesh. Shop online and enjoy massive discounts and free home delivery.'});
    // Twitter
    this.meta.updateTag({name: 'twitter:title', content: 'Dhurobo- Home'});
    this.meta.updateTag({name: 'twitter:image', content: 'https://dhuroboht.com/assets/brand/dhurobo.png'});
    this.meta.updateTag({name: 'twitter:description', content: 'Dhurobo is the sole authorized distributor of SHARP and GENERAL in Bangladesh. Shop online and enjoy massive discounts and free home delivery.'});
