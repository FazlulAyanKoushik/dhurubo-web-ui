...
export class AppComponent implements OnInit {
  ...
  private updateMetaData() {
    // Title
    this.title.setTitle('Dhurobo Ht');

    // Meta
    this.meta.addTag({name: 'author', content: 'Dhurobo Ht'});
    this.meta.addTag({name: 'author', content: 'Dhurobo Ht'});
    this.meta.addTag({name: 'copyright', content: 'Dhurobo Ht'});
    this.meta.addTag({name: 'og:locale', content: 'en_US'});
    // Open Graph
    this.meta.addTag({name: 'og:site_name', content: 'Dhurobo Ht'});
    // Twitter
    this.meta.addTag({name: 'twitter:card', content: 'summary_large_image'});
    this.meta.addTag({name: 'twitter:site', content: '@DhuroboHt'});
    this.meta.addTag({name: 'twitter:creator', content: '@DhurobHt/'});
  }
