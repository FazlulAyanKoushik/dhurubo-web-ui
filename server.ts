...
export function app(): express.Express {
  ...
  server.post('/callback/payment/cancel', (req, res) => {
    res.redirect(301, 'https://dhurobo.softlabit.com/payment/cancel');
  ...
  server.post('/callback/payment/success', (req, res) => {
    ...
    res.redirect(301, 'https://dhurobo.softlabit.com/payment/success');
    // console.log(req.body);
    // res.status(200).json({
    //   data: req.body,
    //   message: 'Data Retrieved Successfully!'
  ...
  server.post('/callback/payment/fail', (req, res) => {
    ...
    res.redirect(301, 'https://dhurobo.softlabit.com/payment/fail');
    // console.log(req.body);
    // res.status(200).json({
    //   data: req.body,
    //   message: 'Data Retrieved Successfully!'
